...
public class RocketmqProducerService {
    ...
    public static final String topic = "test-topic-1"; //定义主题，可分离放在配置文件里面，一般一个主题发送同类消息，主题格式：`topicName:tags`
     ...
     * @Author zhou
     * @Description 延迟消费
     * @Date 17:01 2019/11/25
     * @Param [level]
     * @return boolean
     **/
    public boolean sendMsgObjDelay(int level) {
        Map<String,Object> map = new HashMap<String,Object>();
        map.put("name", "sixmonth");
        map.put("age", "88");
        Message msg = new Message("openSporting", "tem1", map.toString().getBytes());
